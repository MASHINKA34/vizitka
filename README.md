...
- ⚡ **Высокая производительность** благодаря Vite и оптимизации
- 🎯 **SEO-оптимизация** с правильными метатегами
...
Все тексты, изображения и данные находятся в `src/App.tsx`:

- Секция команды — массив с данными участников
- Проекты — массив с описанием кейсов
- Услуги — карточки с ценами
- Контакты — ссылки и форма
...
- 🌐 Website: [voidteam.dev](https://voidteam.dev)
